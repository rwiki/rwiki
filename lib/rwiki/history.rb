...
class HistoryFormat < RWiki::NaviFormat
  include DiffLink
...
class DiffFormat < RWiki::NaviFormat
  include DiffLink
...
RWiki::install_page_module('history', HistoryFormat, _("history"))
RWiki::install_page_module('diff', DiffFormat, _("diff"))
